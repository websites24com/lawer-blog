...
import type { PostSummary, PostWithDetails, Category } from '@/app/lib/definitions';
  ...
  for (const comment of visibleComments) {
    const formatted: CommentWithUser = {
      ...
      user: {
        ...
        slug: '', // optional: populate if needed
...
export async function getPostsByCategorySlug(
  ...
  return { posts, totalCount: countRows[0].count };
}
